...
import org.currency.starter.config.Config.Cors;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${api.base-path.unauth}")
    private String unauthApiPath;
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	http.cors().and().csrf().disable()
                .exceptionHandling().authenticationEntryPoint(unauthorizedHandler).accessDeniedHandler(jwtAccessDeniedHandler).and()
...
//    }
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        List<String> s=cors.getAllowedMethods();
    	for (String ss : s) {
